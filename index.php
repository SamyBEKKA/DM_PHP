...
$articles = isset($_SESSION['carrousel_articles']) ? $_SESSION['carrousel_articles'] : [];
unset($_SESSION['carrousel_articles']);
?>
<!-- Carousel wrapper -->
                              ...
                              <div class="carousel-inner">
                                  <?php foreach ($articles as $index => $article) { ?>
                                      <div class="carousel-item <?php echo $index === 0 ? 'active' : ''; ?>">
                                          <img src="/path/to/your/images/<?php echo htmlspecialchars($article['image']); ?>" class="d-block w-100" alt="Image de l'article">
                                          <div class="carousel-caption d-none d-md-block text-left">
                                              <h5><?php echo htmlspecialchars($article['name_travel']); ?></h5>
                                              <p><?php echo htmlspecialchars($article['name_country']); ?></p>
                                          </div>
                                      </div>
                                  <?php } ?>
                              </div>
