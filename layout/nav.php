...
<nav class="container">
        <ul class="nav justify-content-center">
            ...
            <li class="nav-item nav ">
                <a class="nav-link" href="../upload.php">U-A</a>
            </li>
            <li>
                <form class="form-inline ml-auto" action="process/search-process.php" method="GET">
                <input class="form-control mr-sm-2" type="search" placeholder="Recherche ville, pays, ou continent" aria-label="Search" name="query">
